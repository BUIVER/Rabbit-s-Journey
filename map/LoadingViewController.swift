                           ...
                           /*  let region = JSON[index].value(forKey: "region") as! String
                            ...
                            Alamofire.request("http://flags.fmcdn.net/data/flags/w1160/\(alpha2code.lowercased()).png").responseImage { response in
                                print(response)
                                    ...
                                    if (flag != nil){
                                        self.image = flag!
                                        guard let country = Data(name: name, flag: self.image, alpha2Code: alpha2code, alpha3Code: alpha3code, altSpellings: altSpellings, area: area as! Double, borders: borders, capital: capital, population: population as! Int)
